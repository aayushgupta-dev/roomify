  ...
  return (
    <div className="home">
      ...
      <section className="hero">
        ...
        <p className="subtitle">Roomify is an AI-first design environment that helps you visualize, render, and shift architectural projects faster than ever.</p>
            ...
            <div className="project-card group">
              ...
              <div className="card-body">
                <div>
                  ...
                  <div className="meta">
                    <Clock size={12} />
                    <span>{new Date('01.19.2026').toLocaleDateString()}</span>
                    <span>By Irina</span>
                  </div>
                </div>
                <div className="arrow">
